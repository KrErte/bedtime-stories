...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.settings), leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: () => context.go('/home'))),
      body: Padding(
          ...
          Card(child: Padding(padding: const EdgeInsets.all(16), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                ...
                child: Text(auth.isPro ? l.pro : l.free, style: TextStyle(fontSize: 12, color: auth.isPro ? AppTheme.storyPurple : AppTheme.navy300)),
              ),
            ]),
            if (!auth.isPro) TextButton(onPressed: () => context.go('/subscribe'), child: Text(l.upgrade, style: const TextStyle(color: AppTheme.storyPurple))),
          ]))),
