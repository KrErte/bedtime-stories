...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.library), leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: () => context.go('/home'))),
      ...
      body: _loading
          ...
          : _stories.isEmpty
              ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text(l.noStoriesYet, style: TextStyle(color: Colors.white.withOpacity(0.5))),
                  const SizedBox(height: 16),
                  ElevatedButton(onPressed: () => context.go('/new-story'), child: Text(l.createStory)),
                ]))
              : ListView.builder(
                      ...
                      child: Card(
                        ...
                        child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(s.content.length > 120 ? '${s.content.substring(0, 120)}...' : s.content,
                              style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                          const SizedBox(height: 8),
                          Row(children: [
                            Text('${s.contentWordCount} ${l.words}', style: TextStyle(fontSize: 11, color: Colors.white.withOpacity(0.3))),
